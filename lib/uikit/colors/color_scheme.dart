...
class AppColorScheme extends ThemeExtension<AppColorScheme> {
  ...
  AppColorScheme.light()
      : primary = LightColorPalette.white,
        ...
        surfaceSecondary = LightColorPalette.lightBlue,
        onSurface = LightColorPalette.chineseBlack,
        background = LightColorPalette.cultured,
        backgroundSecondary = LightColorPalette.lightBlue,
  ...
  AppColorScheme.dark()
      : primary = DarkColorPalette.lightBlack,
        ...
        surfaceSecondary = DarkColorPalette.lightBlue,
        onSurface = DarkColorPalette.white,
        background = DarkColorPalette.raisinBlack,
        backgroundSecondary = DarkColorPalette.lightBlue,
