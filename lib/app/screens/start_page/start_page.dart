...
// var controllerPhotos = new StreamController<AssetImage>();
// StreamSubscription subscription = controllerPhotos.stream.listen((item) => print(item));
...
// ]
    ...
    return Scaffold(
      ...
      title: Row(
        ...
        children: [
          const Spacer(flex: 2),
          Image.asset('assets/images/lologram.png', width: 140),
          const Spacer(flex: 1)
        ],
      ),
      actions: [
        IconButton(onPressed: (){}, icon: Image.asset('assets/images/iconMenu.png'))
      ],
      ),
